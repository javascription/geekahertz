...
export default function Register() {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        // Stops the page from reloading upon submission
          ...
          return (
            ...
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-lg">
                <div className="w-full flex justify-center">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold">Login</h2>
                </div>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {error &&
                        <div
                            className="unselectable relative top-4 lg:top-8 font-light text-center text-red-600 dark:text-red-700 sm:text-sm"
                        >
                            {error}
                        </div>
                    }
